...
<div class="vote-view">
    ...
    <p>
        <?= Html::a('Изменить', ['update', 'id' => $question->id], ['class' => 'btn btn-primary']) ?>
        ...
        <?php if ($question->isActive()): ?>
            <?= Html::a(Yii::t('app', 'Draft'), ['draft', 'id' => $question->id], ['class' => 'btn btn-default pull-right', 'data-method' => 'post']) ?>
        <?php else: ?>
            <?= Html::a(Yii::t('app', 'Activate'), ['activate', 'id' => $question->id], ['class' => 'btn btn-success', 'data-method' => 'post']) ?>
        <?php endif; ?>
    </p>
